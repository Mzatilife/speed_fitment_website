      ...
      <header className="bg-gradient-to-r from-brand-950 via-brand-900 to-brand-800 sticky top-0 z-20 shadow-lg shadow-brand-950/15">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <img src="/logo.png" alt="Speed Fitment and service center" className="w-9 h-9 rounded-lg object-contain" />
            <div className="leading-none">
              <span className="font-extrabold text-white block">Speed Fitment</span>
              <span className="text-[9px] text-white/70 block mt-1">and service center</span>
            </div>
          </Link>
